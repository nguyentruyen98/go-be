...
// Source: github.com/nguyentruyen98/go-be/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransfersTx(arg0 context.Context, arg1 db.TransferTxParam) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
